...
<body>
	...
	<form:form id="searchForm" modelAttribute="category" action="${ctx}/cms/category/" method="post" class="breadcrumb form-search">

		<label>语言：</label><form:select path="locale">
