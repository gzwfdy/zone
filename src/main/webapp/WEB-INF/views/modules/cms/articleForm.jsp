...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="hidden" readonly="readonly" id="attachment" name="attachment" data-filename="${article.attachment}" value="${article.attachment}" />
				<sys:ckfinder input="attachment" type="files" uploadPath="/cms/files" selectMultiple="true"/>
			</div>
		</div>
		<div class="control-group">
