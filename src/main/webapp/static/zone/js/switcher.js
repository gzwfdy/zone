...
//Header Color Change
$(".main-header").spectrum({
    showInitial: true,
	color: $("#header .main-header").css("background"),
...
$(".top-bar").spectrum({
	showInitial: true,
	color: $("#header .top-bar").css("background"),
	preferredFormat: "hex6",
	showInput: true,
	move: updateHeaderTop
});
//Changing the header color instantly
function updateHeaderTop(color) {
	$("#header .top-bar").css("background", color.toHexString());
}


$(".panel-heading").spectrum({
	showInitial: true,
	color: $(".panel-heading").css("background-color"),
	preferredFormat: "hex6",
	showInput: true,
	move: updateHeaderPanelHeading
});
//Changing the header color instantly
function updateHeaderPanelHeading(color) {
	$(".panel-heading").css("background-color", color.toHexString());
}

//Footer Top Color Change
$(".footer-top").spectrum({
    showInitial: true,
	color: $(".footer-top").css("background"),
	preferredFormat: "hex6",
    showInput: true,
...
$(".footer-bottom").spectrum({
    showInitial: true,
	color: $(".footer-bottom").css("background"),
	preferredFormat: "hex6",
    showInput: true,
