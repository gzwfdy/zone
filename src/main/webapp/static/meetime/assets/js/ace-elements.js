...
(function($ , undefined) {
	...
	Ace_File_Input.prototype.apply_settings = function() {
		...
		this.$element.after('<span class="ace-file-container" data-title="'+this.settings.btn_choose+'"><span class="ace-file-name" data-title="'+this.settings.no_file+'">'+(this.settings.no_icon ? '<i class="'+ ace.vars['icon'] + this.settings.no_icon+'"></i>' : '<img src="meetime/assets/images/8.png" style="text-align: left !important;width:222px;height: 77px" />')+'</span></span>');
