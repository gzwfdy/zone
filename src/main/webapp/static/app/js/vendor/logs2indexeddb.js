...
var l2i = {
    ...
    consoles: {
         ...
         */
        both: {
        	// TODO: handle all arguments not just first!
            log: function(str) {
                l2i.consoles.original.log(str);
                l2i.consoles.indexeddb.log(str);
            },
            warn: function(str) {
            	(l2i.consoles.original.warn || l2i.consoles.original.log).call(l2i.consoles.original, str);
                l2i.consoles.indexeddb.warn(str);
            },
            trace: function(str) {
            	// console.trace doesn't exist in IE10
            	(l2i.consoles.original.trace || l2i.consoles.original.log).call(l2i.consoles.original, str);
                l2i.consoles.indexeddb.trace(str);
            },
            error: function(str) {
            	(l2i.consoles.original.error || l2i.consoles.original.log).call(l2i.consoles.original, str);
                l2i.consoles.indexeddb.error(str);
            },
            info: function(str) {
            	(l2i.consoles.original.info || l2i.consoles.original.log).call(l2i.consoles.original, str);
                l2i.consoles.indexeddb.info(str);
            },
            debug: function(str) {
            	// console.debug doesn't exist in IE10
            	(l2i.consoles.original.debug || l2i.consoles.original.log).call(l2i.consoles.original, str);
        ...
        indexeddb: {
            ...
            write2db: function(label, str) {
                ...
                log_str = stringify(str);
            	//l2i.consoles.original.log("writing '" + log_str + "' to object store");
                var data = {
                	// epoch time * 1000
                    time: time.getTime()+'',
                    label: label,
