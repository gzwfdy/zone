...
public class CategoryController extends BaseController {
	...
	public String list(Category category,Model model) {
		...
		List<Category> sourcelist = categoryService.findByUser(true, null,category);
	...
	public String form(Category category, Model model) {
		...
		category.setLocale(parent.getLocale());
	...
	public List<Map<String, Object>> treeData(Category category,String module, @RequestParam(required=false) String extId, HttpServletResponse response) {
		response.setContentType("application/json; charset=UTF-8");
		List<Map<String, Object>> mapList = Lists.newArrayList();
		category.setLocale("all");
		List<Category> list = categoryService.findByUser(true, module,category);
